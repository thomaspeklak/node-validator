...
exports.clean = function(str, is_image, allowed_tags) {
    ...
    if (allowed_tags && Object.prototype.toString.call(allowed_tags) === '[object Array]') {
        for(var i = 0; i < allowed_tags.length; i++) {
            naughty = naughty.replace(new RegExp(allowed_tags[i] + "\\|?"), "");
        }
    }
